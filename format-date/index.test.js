const assert = require('assert'); //importujemy moduł assert - udostępnia funkcje do asercji
const formatDate = require('./index'); //importujemy funkcję, którą będziemy testować i przypisujemy ją do zmiennej

//describe pozwala nam grupować testy. test suite - zbiór testów
// describe(nazwa test suite, callback - funkcja w której znajdą się testy
// lub kolejne test suites)
describe('formatDate', () => {
    describe('seconds', () => {
        //it, test - testy (funkcje testowe)
